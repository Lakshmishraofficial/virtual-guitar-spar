...
(function() {
    ...
    (function() {
        ...
        if (tagUrl.includes("tag_version")) {
            cmpVersion = 'https://cmp.quantcast.com/tcfv2/CMP_FILE?referer=www.musicca.com'.replace('CMP_FILE', cmpFile);
        } else {
            cmpVersion = 'https://quantcast.mgr.consensu.org/tcfv2/CMP_FILE?referer=www.musicca.com'.replace('CMP_FILE', cmpFile);
        }
    ...
    (function() {
        var css = "" +
            " .qc-cmp-button { " +
            "   background-color: #72AC51 !important; " +
            "   border-color: #72AC51 !important; " +
            " } " +
            " .qc-cmp-button:hover { " +
            "   border-color: #72AC51 !important; " +
            " } " +
            ...
            " } " +
            "#qc-cmp2-ui button[mode=\"link\"] {text-decoration: none;color: #878787;transition:0.25s ease;}" +
            "" +
            "";
    ...
    window.__tcfapi('init', 2, function() {}, {
        "coreConfig": {
            ...
            "hashCode": "cT/hOR3vS72BFh0p8KI+HQ",
            "publisherCountryCode": "DK",
            "publisherName": "Musicca",
        ...
        "premiumUiLabels": {},
        "premiumProperties": {
            "nonIabVendorListUrl": "https://cmp.quantcast.com/choice/PRrmquD1Ggcb1/www.musicca.com/.well-known/noniab-vendorlist.json",
            "nonIabVendorListUrlOld": "https://quantcast.mgr.consensu.org/choice/PRrmquD1Ggcb1/www.musicca.com/.well-known/noniab-vendorlist.json",
            "vendorBlacklist": [896],
            "googleWhitelist": [1]
        },
        "coreUiLabels": {
        ...
        "theme": {
            "uxPrimaryButtonColor": "#72AC51",
            "uxSecondaryButtonTextColor": "#72AC51",
            "uxLinkColor": "#878787"
        },
        "nonIabVendorsInfo": {
            "nonIabVendorList": [{
